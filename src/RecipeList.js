        ...
        <Fragment>
            {deleteId !== "" ? (
                <Modal
                    ...
                    onClosed = {() => setDeleteId("") }>Biztosan törlöd a {recipes.find((recipe) => recipe.id === deleteId) ?.name} recepjét?</Modal>
            ): ( "" )}
                        ...
                        <div className="col-md-4" key={recipe.id}>
                            <div className="card w-100 h-100">
                                ...
                                <div className="w-75 p-3">
                                    ...
                                    {/* <NavLink to={`/recept/${recipe.slug}`}> */}
                                        <button className="btn btn-sm btn-outline-danger ml-2" onClick={() => {setDeleteId(recipe.id)}}>
